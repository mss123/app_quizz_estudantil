...
//Tela perguntas Variedades _ Difícil //
void main() => runApp(DecimaTerceiraRota());

class DecimaTerceiraRota extends StatelessWidget {
  @override
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions(
        "1. A sigla 'ENEM', significa Exame Nacional do Ensino Medio.", true),
    Questions(
        "2. O Curso de Sistemas de informações está no ramo da tecnologia.",
        true),
    Questions(
        "3. O Sistema operacional Android foi desenvolvido em 2010.", false),
    Questions("4. O primeiro Iphone foi lançado em 2007.", true),
    Questions("5. A tecnologia está em decadência atualmente.", false),
  ];
