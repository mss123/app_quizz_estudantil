...
//Tela perguntas Matemática _ Média //
void main() => runApp(NonaRota());
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1) Esse simbolo + é de subtração: ", false),
    Questions("2) Esse simbolo - é de adição: ", false),
    Questions("3) 33 x 33 = 1089", true),
    Questions("4) 47 dividido por 47 = 1", true),
    Questions("5) 10 dividido por 5 = 1", false),
  ];
