...
//Tela perguntas Infantil _ Difícil //
void main() => runApp(DecimaSextaRota());

class DecimaSextaRota extends StatelessWidget {
  @override
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1.O triangulo tem 3 lados: ", true),
    Questions("2.O quadrado tem 4 lados: ", true),
    Questions("3.O triangulo tem 4 lados:", false),
    Questions("4.O Brasil faz parte da america do sul: ", true),
    Questions(
        "5.As cores da bandeira da Argentina são verde e amarela:", false),
  ];
