...
//Tela perguntas Matemática_Básico //
void main() => runApp(QuintaRota());
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1)  10 + 10 = 20.", true),
    Questions("2)  10 x 0 = 0", true),
    Questions("3)  1 + 1 = 0", false),
    Questions("4)  10 x 10 = 0", false),
    Questions("5)  30 - 25 = 5", true),
  ];
