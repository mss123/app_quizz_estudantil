...
//Tela perguntas Infantil _ Médio //
void main() => runApp(DecimaSegundaRota());

class DecimaSegundaRota extends StatelessWidget {
  @override
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1.A Monica tem um coelho chamado Sansão: ", true),
    Questions("2.As cores da bandeira do Brasil são verde e amarela: ", true),
    Questions("3.O sapo é verde:", true),
    Questions("4.Quem vive no Brasil é chamado de Argentino:", false),
    Questions("5.A novela carrossel se passa em uma escola: ", true),
  ];
