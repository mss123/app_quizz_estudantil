...
//Tela perguntas Variedades _ Médio //
void main() => runApp(OitavaRota());
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1. O futebol é um dos esportes mais importantes.", true),
    Questions("2. Real Madrid é um clube brasileiro.", false),
    Questions("3. Estados Unidos é um país rico.", true),
    Questions("4. Good Morning em português significa 'Bom Dia'.", true),
    Questions("5. O Natal é no mês de junho.", false),
  ];
