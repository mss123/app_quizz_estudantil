...
//Tela perguntas Português_Básico //
void main() => runApp(SextaRota());
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1.O ponto de interrogação é “?”: ", true),
    Questions("2.O contrário de bom é mau com (u):", true),
    Questions("3.Gato é substantivo próprio: ", false),
    Questions("4.Cachorro é substantivo comum: ", true),
    Questions("5.Porque junto é utilizado em perguntas: ", false),
  ];
