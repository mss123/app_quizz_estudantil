...
//Tela perguntas Português _ Médio //
void main() => runApp(DecimaRota());
...
class _StartPageState extends State<StartPage> {
  ...
  List qList = [
    Questions("1.Não tem diferença entre mau e mal: ", false),
    Questions("2.A letra Q pode ser usada sozinha: ", false),
    Questions(
        "3.O uso da consoante M é obrigatório antes das consoantes P e B: ",
        true),
    Questions("4.Carlos é substantivo Próprio: ", true),
    Questions("5.O termo verbal “iremos” está no presente: ", false),
  ];
